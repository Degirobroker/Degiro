...
def register(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            login(request, user)
            messages.success(request, f'Congratulations {user.first_name}! Your account has been successfully created, make a deposit to get started and see an active balance and plan! An account manager, Mrs. Emilia, has been assigned to you, her email address is on your portfolio here. Contact her for any inquiries you might have.')
